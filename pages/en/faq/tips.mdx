---
title: "Tips & Tricks"
description: "Helpful tips and tricks for using Redbrick Studio effectively."
---
...
<Callout type="info">
  ![options-image](/images/script-window-code-drag.png) Drag the lines to enable
  or disable comments. ![options-image](/images/script-window-comment.png) Then
  use `window : Control + /` `mac : Command + /` to toggle comments.
</Callout>
