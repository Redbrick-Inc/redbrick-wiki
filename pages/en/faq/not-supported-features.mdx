...
### Restart Scene or Game

Currently, the Redbrick engine does not have a built-in function to restart or reset the game.  
Therefore, to use this functionality, you need to [create a custom function to reset the game](./questions#how-do-i-create-a-retry-button).

### Pause Game

There is currently no built-in functionality in the Redbrick engine to pause the game.  
To use this feature, create a [custom function to pause the game](./questions#how-do-i-create-a-function-to-pause-the-game).  
