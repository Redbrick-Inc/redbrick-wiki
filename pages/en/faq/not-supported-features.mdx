...
### After closing the script window, Control + Z

You can use Control + Z within the script window, but once you close the script window, the recorded code changes up to that point will be reset.  
