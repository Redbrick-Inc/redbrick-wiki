---
title: "Unsupported Features in Redbrick Engine"
description: "A comprehensive list of features currently not supported by the Redbrick Engine, along with possible workarounds."
---
...
To use this functionality, create a [custom function to reset the game](../snippet/game-flow/reset-game.mdx).

### Pausing the Game

Currently, the Redbrick Engine does not have a function to pause the game.  
To use this functionality, create a [custom function to pause the game](../snippet/game-flow/pause-game.mdx).
