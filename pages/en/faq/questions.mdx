...
<Callout type="error" icon="‼️">
  ...
  <div style={{ textAlign: "center" }}>
    <center>
      ![redbrick-extension_physics-body](/images/snippet/redbrick-extension/redbrick-extension_physics-body.png) Physics > Body
    </center>
  </div>
  <br/>
  <br/>
...
For more details, please refer to [this guide](../snippet/create-functionality-reset-game.mdx).

### How to Create a Pause Function?

Currently, Redbrick Studio does not have a dedicated function to pause the game.  
However, you can achieve a similar effect with a custom function.  
For more details, please refer to [this guide](../snippet/create-functionality-pause-game.mdx).
...
If you want to change the appearance of your avatar during gameplay, refer to this [snippet](../snippet/change-avatar-appearance.mdx).
