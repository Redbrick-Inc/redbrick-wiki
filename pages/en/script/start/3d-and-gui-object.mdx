...
Select the Layer tab on the left panel, then select the World tab to see a list of 3D objects in the scene.
...
The object labeled as "default" with a globe icon is the WORLD object.  
...
Select the Layer tab on the left panel, then select the GUI tab to see a list of GUI objects in the scene.
