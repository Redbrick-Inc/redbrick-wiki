...
In creating a single-player game, the scripts you will use can be categorized into two types: object scripts and client scripts.  
...
If you use client scripts instead of object scripts, you need to explicitly specify which object to reference using methods like `getObject()`. 

```js showLineNumbers filename="Client Script"
