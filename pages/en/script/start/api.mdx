---
title: "Redbrick Studio API Documentation"
description: "Comprehensive guide on the APIs available in Redbrick Studio, including three.js integration and built-in modules."
---
...
By default, all objects can use the API of three.js for each class, but for some objects, API Extension has been added for the object's special purpose or for ease of use. Details can be found on the [API Extensions page](../api).
