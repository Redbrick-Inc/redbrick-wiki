...
All properties of the original object, including geometric shape, material, position, rotation, and scale, are copied.  
The cloned object is completely independent of the original object, so changes to the cloned object will not affect the original object.
...
value - The value of the property to search for. The method searches the scene graph for an object that matches the specified property and value.
