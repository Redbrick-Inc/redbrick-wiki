...
It clones an object and returns a new object.  
The new object is created by copying the properties of the original object, including its geometry, material, position, rotation, and scale.  
However, the Physics and Behavior properties are not copied.  
The cloned object is completely independent of the original object, so any changes to the cloned object will not affect the original object.
