...
- `options` (optional): An object with the following properties:
  - `theme` (string, optional): The visual theme for the ranking UI. Default is "default". 
  - `type` (string, optional): The type of ranking display. Default is "default".
...
```javascript
// Show ranking with timer/time option: hh:mm:ss
REDBRICK.Rank.show({
  type: "time",
});
```
