...
1. **Metaverse**: In this mode, the camera always follows the avatar.

2. **Game**: In this mode, an avatar is optional. It is up to the user to decide if they want an avatar and whether the camera should follow it. This option provides high flexibility.

3. **VR**: This mode supports virtual reality. If you choose the Metaverse and enable VR, the VR experience will automatically be linked to the avatar. In the Game mode, the placement of VR depends on the user's preference.
