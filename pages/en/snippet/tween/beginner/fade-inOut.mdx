...
<Steps>
    ...
    a. Set the name of the object to "black."
    ...
    c. Set the transparency to 100 so that the black image starts off invisible.
    <br/>
    ...
    Add an object (client) script to the black image GUI. Use TWEEN to adjust the opacity of the black image. <br/>
