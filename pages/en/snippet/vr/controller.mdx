---
title: "Controller Introduction"
description: "We introduce related functions that can be utilized when developing controller interactions."
hideTitle: true
---

import { Cards } from "nextra/components";

# Introduction of Controller-Related Functions
...
<Cards>
  <Cards.Card
    title="Remove Default VR Settings"
    href="/kr/snippet/vr/controller/Remove-Basic-VR"
  />
  <Cards.Card
    title="Introduction to Trigger-related functions"
    href="/kr/snippet/vr/controller/Trigger"
  />
  <Cards.Card
    title="Introduction to Grab-related functions"
