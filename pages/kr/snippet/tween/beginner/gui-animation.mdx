...
<Steps>
    ...
    <br/>
    <center>![gui-animation_step-1](/images/tween/beginner/gui-animation/gui-animation_step-1.png) GUI에 이미지 추가하기</center>
    ...
    <br/>
    <center>![gui-animation_step-2-a](/images/tween/beginner/gui-animation/gui-animation_step-2-a.png) 이미지 사이즈 설정하기</center>
    <br/>

    ##### b. 이미지의 시작위치를 설정해줍니다.
        Anchor를 통해 이미지의 기준점을 잡아주고 Offset을 조정해줍니다.
    <br/>
    <center>![gui-animation_step-2-b](/images/tween/beginner/gui-animation/gui-animation_step-2-b.png) 이미지 시작위치 설정하기</center>
    ...
    offset 객체는 간략하게 본다면 `{ x : { value : Number }, y : { value : Number } }`로 구성되어 있기 때문에 한 축으로만 값을 변경하고 싶다면 `ui.offset.y`를 TWEEN의 초기객체로 사용해주어야 합니다. <br/>

    yoyo 옵션을 사용하기 때문에 GUI 애니메이션 시간은 `tween.to(object, duration)`에서 duration의 2배가 됩니다. 
    <Link href='/kr/script/built-in/tween/easing'><u>.easing()</u></Link>을 통해 객체의 움직임(보간 방정식)을 변경할 수 있습니다. <br/>
    <br/>
    <center>
        <img src="/images/tween/beginner/gui-animation/gui-animation_easing.gif" alt="gui-animation_easing" style={{ maxWidth: '50%', height: 'auto' }}/>
...
### 결과물
<br/>
<center>![gui-animation_result](/images/tween/beginner/gui-animation/gui-animation_result.gif) GUI 애니메이션 결과물</center>
