...
[`.lookAt()`](../script/built-in/three/object3d#lookat) 메소드를 사용해 간단하게 구현할 수 있습니다.  
...
## 오브젝트가 항상 플레이어를 바라보게 만들기 (y축만 회전)
...
## 오브젝트가 항상 카메라를 바라보게 만들기 (Sprite 사용)
...
만약 카메라를 향하게 하고 싶은 오브젝트가 이미지라면, Three.js에서 제공하는 [`Sprite`](../script/built-in/three/sprite.mdx)를 사용하여 구현할 수도 있습니다.  
