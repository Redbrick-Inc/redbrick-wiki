...
현재 레드브릭 엔진에서 게임을 재시작하거나 초기화 해주는 기능은 지원되지 않습니다.  
따라서 해당 기능을 사용하려면 [사용자 정의 함수로 게임을 초기화하는 기능](./questions#%EC%9E%AC%EC%8B%9C%EC%9E%91-%EA%B8%B0%EB%8A%A5%EC%9D%84-%EC%96%B4%EB%96%BB%EA%B2%8C-%EB%A7%8C%EB%93%9C%EB%82%98%EC%9A%94)을 생성하여 사용하세요.

### 게임 일시정지

현재 레드브릭 엔진에서 게임을 일시정지 해주는 기능은 지원되지 않습니다.  
따라서 해당 기능을 사용하려면 [사용자 정의 함수로 게임을 일시정지하는 기능](./questions#%EA%B2%8C%EC%9E%84%EC%9D%84-%EC%9D%BC%EC%8B%9C%EC%A0%95%EC%A7%80%ED%95%98%EB%8A%94-%EA%B8%B0%EB%8A%A5%EC%9D%84-%EC%96%B4%EB%96%BB%EA%B2%8C-%EB%A7%8C%EB%93%9C%EB%82%98%EC%9A%94)을 생성하여 사용하세요.
