---
title: "레드브릭 엔진에서 지원되지 않는 기능"
description: "레드브릭 엔진에서 현재 지원하지 않는 기능의 포괄적인 목록과 가능한 해결 방법입니다."
---
...
따라서 해당 기능을 사용하려면 [사용자 정의 함수로 게임을 초기화하는 기능](../snippet/game-flow/reset-game.mdx)을 생성하여 사용하세요.

### 게임 일시정지

현재 레드브릭 엔진에서 게임을 일시정지 해주는 기능은 존재하지 않습니다.  
따라서 해당 기능을 사용하려면 [사용자 정의 함수로 게임을 일시정지하는 기능](../snippet/game-flow/pause-game.mdx)을 생성하여 사용하세요.
