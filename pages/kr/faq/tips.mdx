---
title: "팁과 요령"
description: "레드브릭 스튜디오를 효과적으로 사용하기 위한 유용한 팁과 요령입니다."
---
...
<Callout type="info">
  ![options-image](/images/script-window-code-drag.png) 주석을 활성화 또는
  비활성화 할 라인을 드래그 합니다.
  ![options-image](/images/script-window-comment.png) 이후 `window : Control +
  /` `mac : Command + /` 으로 주석을 활성화 & 비활성화 할 수 있습니다.
</Callout>
