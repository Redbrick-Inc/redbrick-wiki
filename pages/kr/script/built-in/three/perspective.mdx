...
<Callout type="info">
    Perspective Camera는 Object3D에서도 상속되므로 아래 설명된 것 외에도 [THREE.Object3D](https://threejs.org/docs/?q=object#api/en/core/Object3D) 및 [THREE.Object3D.PerspectiveCamera](https://threejs.org/docs/?q=pers#api/en/cameras/PerspectiveCamera)에 존재하는 속성과 기능을 사용할 수 있습니다.
</Callout>
